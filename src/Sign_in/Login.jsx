    ...
    return (
        <div className="div_1">
          ...
          <form className="div_2" onSubmit={handleSubmit}>
            ...
            <p><a className="link-opacity-10-hover mr-3" href="#"  onClick={gotoSignUpPage}>Regiter ?</a></p>

            <button type="submit " className="registerbt mt-2 " onClick={gotoSignUpPage} >Sign in</button>
