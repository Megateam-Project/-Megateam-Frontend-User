...
const Detail = () => {
  ...
  return (
    <>
      {roomData.slice(0, 1).map((room, index) => (
        <div key={index}>
          <h2 style={{ marginTop: 80, marginLeft: 80 }}>
            Premium Slavija Garni {room.name}{" "}
          </h2>
          <p style={{ marginLeft: 80 }}>
            Book a stay for more than {room.price} to receive a high-quality
            tour!
          </p>
          <div
              ...
              <div className="col">
                <div className="d-flex flex-column bd-highlight mb-3">
                  ...
                  <div className="p-2 bd-highlight" style={{ marginLeft: 100 }}>
                    <h6 style={{ color: "#7C6A46" }}>${room.price}/ night</h6>
                  </div>
                </div>
              </div>
              <div className="col">
