  ...
  return (
    ...
    >
      ...
      >
        <div
          className="col-6"
          style={{ flex: "0 0 50%", maxWidth: "50%", padding: "10px" }}
        >
          <div
            className="p-lg-5  text-dark rounded"
            style={{ maxWidth: "100%", width: "80vw", textAlign: "left" }}
          >
            <h4>Paradise View</h4>
        ...
        <div
          className="col-6"
          style={{ flex: "0 0 50%", maxWidth: "60%", padding: "10px" }}
        >
          <img
